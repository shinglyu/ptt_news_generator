(function(window, undefined) {
    ...
    var scriptId = "oncc_3111_8585_9251_1" + ts4;
    window.Scupio.alive = window.Scupio.alive || {};
    _s.alive[scriptId] = true;
   
    var iw = '728'; var ih = '90'; var pub = 'lQQCFQA='; var cid = '9251'; var wid = '3111,1,18'; ;
    ...
    var browser = {
        ...
        function loadGeneralAdtype(ts4, iw, ih, cid, wid, pub) {
            var bws = 'm=1&s=0,2,726,88,FFFFFF,15,FFFFFF,1,1,16,1,35,1,0,-1,1,,RB,,,,-1,,7,1,1,0&fs=FFFFFF&shf=&ssf=fsz:11pt,lh:18px,c:0000FF,txd:n&scf=fsz:9pt,lh:16px,c:333333,txd:n&suf=&sif=&pif=90,90,1&si=728,90,1;2;4;17';
            var ic = '#FFFFFF';
        ...
        function loadModalPlayerAdtype(ts4, iw, ih, cid, wid, pub) {
            // player parameters
            var id = ts4;
            var adviewerArg = "&channelid=9251&wid=3111,1,27&PubID=lQQCFQA=";
            var maskwidth = 0;
         ...
         function() {
            ...
            if( (browser.name === "Explorer") ||
                ...
                loadGeneralAdtype(ts4, iw, ih, cid, wid, pub);
                      ...
                      typeof(_s.adtyperatio['27']) !== "undefined" &&
                      (Math.random() > _s.adtyperatio['27']) ) {
                loadGeneralAdtype(ts4, iw, ih, cid, wid, pub);
            }
            else {
